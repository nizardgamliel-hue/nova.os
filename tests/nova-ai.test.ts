...
test("Provider profiles remain centralized on the existing free model",()=>{assert.match(getNovaModel("FAST").model,/free/);assert.equal(getNovaModel("REASONING").provider,"vercel-ai-gateway")});
